...
namespace ConsommiTounsi.Service
{
    public class ChartService
    {
        ...
        //singleton instance httpclient and set Uri(http://localhost:8085);
        ...
        public List<Object[]> getDonationMoyenYear(int year)
        {
            HttpResponseMessage httpResponseMessage = client.GetAsync(springMvcUrl + "/donation/getDonationMoyenYear/"+year).Result;
            ...
            if (httpResponseMessage.IsSuccessStatusCode)
            {
                ...
                //recuperation 1 er json affichage events
                List<Object[]> getDonationMoyenYear = httpResponseMessage.Content.ReadAsAsync<List<Object[]>>().Result;


                return getDonationMoyenYear;
                //recuperation 2 eme json collamount
            }
            return null;
        }
