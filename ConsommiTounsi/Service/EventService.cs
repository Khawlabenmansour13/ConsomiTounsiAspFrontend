...
namespace ConsommiTounsi.Service
{
    public class EventService
    {
        ...
        {
            HttpResponseMessage httpResponseMessage = client.GetAsync(springMvcUrl + "/event/detail-event/" + id.ToString()).Result;
            Event events = null;
        ...
        public HttpResponseMessage addEvent(FormCollection formCollection)
        {
            ...
            var filestream = new FileStream("C:/Users/USER/Desktop/imageevent/" + formCollection["image"], FileMode.Open);
