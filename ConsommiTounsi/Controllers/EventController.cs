...
public class EventController : Controller
{
    ...
    public ActionResult ManageEvent()
    {
        IEnumerable<Event> events;
            ...
            HttpResponseMessage httpResponseMessage = client.GetAsync(springMvcUrl + "/event/get-all-events").Result;
    ...
    [HttpGet]
    public ActionResult InovicesEvent(int id)
    {
        Event e = eventService.getEventById(id);
        if (e != null)
        {
